...
HLS_SEGMENT_SECONDS = 2    # smaller = faster channel switch (client needs ~3 segments to start)
HLS_LIST_SIZE = 10         # keep 10 × 2s = 20s of buffer — same wall-clock as before
