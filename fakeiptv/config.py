...
class ServerConfig:
    ...
    subtitles: bool = True
    subtitle_background: bool = False  # False = semi-transparent background (CSS path); True = solid black box (native path, player controls work)
...
def load_config(path: str = "config.yaml") -> AppConfig:
    ...
    server = ServerConfig(
        ...
        subtitle_background=_env_bool("FAKEIPTV_SUBTITLE_BACKGROUND", server_raw.get("subtitle_background", False)),
        ...
        always_on=_env("FAKEIPTV_ALWAYS_ON", str(server_raw.get("always_on", "false")).lower()),
